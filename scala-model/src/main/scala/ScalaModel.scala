...
object ScalaModel {
  def main(args: Array[String]): Unit = {
    ...
    // Cargamos los datos
    val data = spark.read.format("csv").option("header", "true").option("inferSchema", "true").load("/opt/spark/work-dir/db/salaries_to_train.csv")
    ...
    jobTitleIndexerModel.save("/opt/spark/work-dir/models/jobTitleIndexerModel")
    employmentTypeIndexerModel.save("/opt/spark/work-dir/models/employmentTypeIndexerModel")
    employmentResidenceIndexerModel.save("/opt/spark/work-dir/models/employmentResidenceIndexerModel")
    companyLocationIndexerModel.save("/opt/spark/work-dir/models/companyLocationIndexerModel")
    companySizeIndexerModel.save("/opt/spark/work-dir/models/companySizeIndexerModel")
    ...
    // Especificamos las capas de la red neuronal: 8 entradas, dos capas intermedias de 5 y 4 nodos, y 4 salidas
    val layers = Array[Int](8, 16, 8, 4)
    ...
    model.write.overwrite().save("/opt/spark/work-dir/models/perceptron")
