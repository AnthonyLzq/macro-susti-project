...
object SocketTextStreamApp {
  def main(args: Array[String]): Unit = {
    ...
    val model = LinearSVCModel.load("/opt/spark/work-dir/models/linearSVC")

    val jobTitleIndexerModel = StringIndexerModel.load("/opt/spark/work-dir/models/jobTitleIndexerModel2")
    val employmentTypeIndexerModel = StringIndexerModel.load("/opt/spark/work-dir/models/employmentTypeIndexerModel2")
    val employmentResidenceIndexerModel = StringIndexerModel.load("/opt/spark/work-dir/models/employmentResidenceIndexerModel2")
    val companyLocationIndexerModel = StringIndexerModel.load("/opt/spark/work-dir/models/companyLocationIndexerModel2")
    val companySizeIndexerModel = StringIndexerModel.load("/opt/spark/work-dir/models/companySizeIndexerModel2")
    ...
    val query = predictionColumn
      ...
      .outputMode("append")
      .format("csv")
      .option("path", "/opt/spark/work-dir/predictions2/linearSVC")
      .option("checkpointLocation", "/opt/spark/work-dir/predictions2")
      .start()
